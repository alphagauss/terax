...
- **Agentic workflow:** plans, sub-agents, project instructions via `AGENTS.md`, file read / write / edit / multi-edit / grep / glob, bash with approval gating, background processes
