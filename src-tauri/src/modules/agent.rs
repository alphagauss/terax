...
// Substrings identifying hook commands generated by this version. Used to
// prune our own groups before reinserting so installs are idempotent.
const OWNED_MARKERS: [&str; 2] = ["notify;Terax;", "__terax_notify"];
