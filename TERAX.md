...
- **sidebar/** - primary activity rail plus independently resizable primary and secondary sidebars. The secondary sidebar renders only when at least one view is registered; one view uses its own header, while multiple views get a top rail.
